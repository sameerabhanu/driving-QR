        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
          <div className="px-6 pt-10 pb-6 text-center">
            <div className="mx-auto w-20 h-20 rounded-full bg-brand-50 flex items-center justify-center mb-6">
              <i className="fa-solid fa-car text-brand-600 text-3xl" aria-hidden="true"></i>
            </div>
          ...
          <div className="px-6 py-6 bg-gray-50/80 border-y border-gray-100">
          ...
          <div className="px-6 pb-8 space-y-3">
            <a
              ...
              className="flex items-center justify-center gap-3 w-full py-4 px-6 bg-whatsapp text-white text-lg font-semibold rounded-2xl hover:bg-whatsapp-dark transition-colors"
            >
            ...
            <a
              href={phoneUrl}
              className="flex items-center justify-center gap-3 w-full py-4 px-6 bg-brand-600 text-white text-lg font-semibold rounded-2xl hover:bg-brand-700 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 w-full py-4 px-6 bg-gray-900 text-white text-lg font-semibold rounded-2xl hover:bg-gray-800 transition-colors"
            >
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
